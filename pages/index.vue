                ...
                >
                  ...
                  <div class="flex flex-grow">
                    ...
                    <nuxt-link :to="'/video/'+i.id" class="flex-center shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 rounded text-gray-200 hover:bg-gray-100/25 " preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.25 2.75h-5.5v10.5h10.5v-5.5m0-5l-5.5 5.5m3-6.5h3.5v3.5"/></svg>
                    </nuxt-link>
                  </div>
                </div>
              </div>
