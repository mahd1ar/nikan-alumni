<template>
  <div class="bg-gray-100 tracking-wider tracking-normal">
    ...
    <div v-if="$fetchState.pending === false" class="">
      <h1
        class="text-4xl text-right mb-10 px-2 pt-8 lg:pt-16 mt-16 container mx-auto"
      >
        {{ title }}
      </h1>

      <div
        class="w-full flex flex-wrap bg-white border-t-2 border-gray-400 border-rounded"
      >
        <div
          class="w-full lg:w-full p-8 mt-6 lg:mt-0 mx-auto text-gray-900 leading-7 container"
        >
