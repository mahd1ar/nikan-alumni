      ...
      <nav class="md:mx-w-6xl p-4 md:container md:mx-auto md:py-4 xl:px-0">
        <div class="hidden lg:flex lg:items-center lg:justify-between">
          <a href="#" class="group flex items-center gap-2">
            ...
            <div class="flex flex-col transform translate-y-1">
          ...
          <nuxt-link
            class="flex justify-center items-center flex-row-reverse text-sm gap-4 px-2 py-2 mr-10 text-gray-500 hover:bg-gray-100 xl:px-4"
            to="/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <div title="exit">
                <div
                  ...
                  class="rounded-md overflow-hidden p-1 cursor-pointer bg-sky-50 text-sky-400 hover:bg-gray-200 flex gap-2 px-3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    aria-hidden="true"
